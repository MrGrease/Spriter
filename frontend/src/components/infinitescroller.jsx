...
>
          ...
          {this.state.items.map((i, index) => (
            <Col key={index} lg="2" md="4" sm="6" xs="12">
              <ImageCell className="ImageCell" link = {this.state.items[index].link} refresher={false} thumbNail = {this.state.items[index].thumbNail} Id = {this.state.items[index]._id}> - #{index}</ImageCell>
            </Col>
          ))}
</Row>
